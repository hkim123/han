...
vlan13    Link encap:Ethernet  HWaddr 64:00:6a:f7:15:bd  
          ...
          UP BROADCAST RUNNING PROMISC MULTICAST  MTU:1500  Metric:1
          RX packets:0 errors:8 dropped:0 overruns:0 frame:0
          TX packets:1 errors:7 dropped:0 overruns:0 carrier:0
          collisions:0 txqueuelen:0 
          RX bytes:0 (0.0 B)  TX bytes:42 (42.0 B)
"""
...
for line in output_list:
    ...
    if('errors' in line):
        ...
        print("RX Errors : %s" %match.group(1))
        print("TX Errors : %s" % match.group(1))
...
if i > 0:
    ...
    # def check_interface_errors(self,deviceObjRef):
    #     self.mydevice = Device.getDeviceObject(deviceObjRef)
    #     output = self.mydevice.execute("ifconfig -a", mode="NGOSroot")
    #     print("print output:" + output)
    #     output_list = output.split('\n')
    #     print("print output_list: " + output_list)
    #
    #     i = 0
    #     for line in output_list :
    #         if('Link' in line) :
